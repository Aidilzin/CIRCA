...
- 3.4.1 Data Collection
  - 3.4.1.1 Public bare-board datasets (PKU-Market-PCB-ver1, DsPCBSD+ — Lv et al. 2024, Roboflow PCB Defect Dataset) — IPC-A-600 territory, retained for completeness
  ...
  - 3.4.1.4 Unified 15-class IPC taxonomy (10 bare-board IPC-A-600 classes + 5 assembly-stage IPC-A-610 classes)
...
- 3.4.3 Data Analysis
  - 3.4.3.1 Class distribution audit (15 classes; ~10:1 bare-board↔solder imbalance; mitigation: `cls_pw=1.0` inverse-frequency power)
...
- 4.2.1 Final Class Distribution — 15 IPC classes, 10 bare-board (IPC-A-600) + 5 solder (IPC-A-610) (Table 4.1)
